        ...
        <div class="">
            <div class="row flex justify-between">
                <div class="col">
                    ...
                    <p>Realisasi 5 tahun terakhir Berdasarkan Kode Akun</p>
                </div>
                <div class="col py-4">
            ...
            <div class="mt-4 overflow-auto">
                <table class="bg-white text-left w-full border-collapse"> <!--Border collapse doesn't work on this site yet but it's available in newer tailwind versions -->
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="py-4 px-6 bg-grey-lightest font-bold text-sm text-grey-dark border-b border-grey-light">Kode Akun</th>
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-grey-lighter">
                            <td class="py-4 px-6 border-b border-grey-light">{{ $realisasi['kode_akun'] }}</td>
